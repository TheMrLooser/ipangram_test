...
import { signInFormValidation } from "../validations/signIn";
...
export const SignIn = () => {
  const { error, setError, setUser } = React.useContext(GlobalContaxt);
  ...
  const submitForm = async (data) => {
    const res = await $crud.post("/auth/signin", data);
